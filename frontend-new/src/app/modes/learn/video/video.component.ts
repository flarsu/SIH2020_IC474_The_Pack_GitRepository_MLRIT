...
import {VPopUpComponent} from '../v-pop-up/v-pop-up.component';
...
export class VideoComponent implements OnInit {
  ...
  public brokenLines = [];
  public languages = [{name: 'Hindi', code: 'hi'}, {name: 'Russian', code: 'ru'}, {name: 'English', code: 'en'}];
  public toLang = 'en';
  ngOnInit(): void {}
  onUpload(event: any) {
    this.isupload = true;
  ...
  submit(speechText) {
    ...
    this.addService.translate({text: speechText, toLang: this.toLang}).subscribe((res0: any) => {
      ...
      this.addService
        ...
        .subscribe((res1: any) => {
          ...
          this.addService.getPos({ text: speechText }).subscribe((res2: any) => {
            const imageSearch = [];
